...
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tmc-operations/10-tkg-create-build.sh -O tmc/10-tkg-create-build.sh
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tmc-operations/11-aks-create-development.sh -O tmc/11-aks-create-development.sh
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tmc-operations/12-eks-create-staging.sh -O tmc/12-eks-create-staging.sh
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tmc-operations/13-gke-create-production.sh -O tmc/13-gke-create-production.sh
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tmc-operations/14-tanzu-management-cluster-setup.sh -O tmc/14-tanzu-management-cluster-setup.sh
