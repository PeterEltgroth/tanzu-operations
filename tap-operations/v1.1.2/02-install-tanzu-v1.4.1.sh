...
wget https://tanzustorage.blob.core.windows.net/tanzu/tanzu-cli-bundle-linux-amd64-v0.11.6.tar
tar -xvf tanzu-cli-bundle-linux-amd64-v0.11.6.tar
rm tanzu-cli-bundle-linux-amd64-v0.11.6.tar
