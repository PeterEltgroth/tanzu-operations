...
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tanzu-application-platform/00-app-demo.sh -O tap/00-app-demo.sh
wget https://raw.githubusercontent.com/nycpivot/tanzu-operations/main/tanzu-application-platform/00-app-service-demo.sh -O tap/00-app-service-demo.sh
